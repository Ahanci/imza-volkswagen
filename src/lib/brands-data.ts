...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    history: '1931 yılında Ferdinand Porsche tarafından kurulan Porsche, spor otomobil dünyasının en prestijli markalarından biridir. 2012 yılından bu yana Volkswagen Grubu çatısı altında faaliyet göstermektedir.',
    advantages: [
      'Orijinal Porsche parça + ZF, Sachs, Brembo yan sanayi',
      'Tüm Porsche modelleri (911 → Taycan)',
      'PDK şanzıman parçaları uzmanı',
      'Performans fren sistemleri (PCCB, PSB)',
      'VIN ile doğru eşleşme garantili',
      'Faturalı, garantili satış',
    ],
    periyodikPaketleri: [
      {
        ...
        km: '15.000 km',
        etiket: 'Hızlı',
        aciklama: 'Porsche motor yağı + yağ filtresi değişimi. Orijinal Mobil 1 veya yan sanayi.',
        parcalar: [
          { ad: 'Motor Yağı 504/507 (5-7L)', marka: 'Mobil 1 / Castrol / OEM' },
          { ad: 'Yağ Filtresi', marka: 'Mann / Mahle / OEM' },
          { ad: 'Tapası contası', marka: 'OEM' },
        ],
        tahminiSure: 'Stoktan 1-3 gün',
        garantiNotu: 'Faturalı, garantili',
      },
      {
        id: 'standart',
        ...
        km: '30.000 km',
        etiket: 'Önerilen',
        aciklama: 'Porsche için komple periyodik filtre seti + fren kontrolü.',
        parcalar: [
          { ad: 'Motor Yağı 504/507 (5-7L)', marka: 'Mobil 1 / Castrol / OEM' },
          { ad: 'Yağ Filtresi', marka: 'Mann / Mahle / OEM' },
          { ad: 'Hava Filtresi', marka: 'Mann / Mahle / OEM' },
          { ad: 'Polen / Kabin Filtresi', marka: 'Mann / Bosch' },
          { ad: 'Fren Balata Ön Seti', marka: 'Brembo / TRW / OEM' },
          { ad: 'PDK Şanzıman Yağı (gerekirse)', marka: 'OEM' },
        ],
        tahminiSure: 'Stoktan 1-3 gün',
        garantiNotu: 'Orijinal Porsche veya Brembo önerilir',
      },
      {
        id: 'genis',
        ad: 'Geniş Bakım',
        km: '60.000 km',
        etiket: 'Popüler',
        aciklama: 'Porsche için tam periyodik bakım. Fren hidroliği, buji, ateşleme bobini dahil.',
        parcalar: [
          { ad: 'Motor Yağı 504/507 (5-7L)', marka: 'Mobil 1 / OEM' },
          { ad: 'Yağ Filtresi', marka: 'Mann / Mahle / OEM' },
          { ad: 'Hava Filtresi', marka: 'Mann / Mahle / OEM' },
          { ad: 'Yakıt Filtresi', marka: 'Mann / Mahle / OEM' },
          { ad: 'Polen Filtresi (Aktif Karbon)', marka: 'Mann / Bosch' },
          { ad: 'Fren Balata Ön Seti (PCCB opsiyonu)', marka: 'Brembo / OEM' },
          { ad: 'Fren Hidroliği DOT 4 / DOT 5.1', marka: 'ATE / Brembo' },
          { ad: 'Buji Seti (6 silindir)', marka: 'NGK / Bosch / OEM' },
          { ad: 'Ateşleme Bobini Seti', marka: 'Bosch / OEM' },
        ],
        tahminiSure: 'Stoktan 2-5 gün',
        garantiNotu: '1-2 yıl garanti (orijinal: 2 yıl)',
      },
      {
        id: 'triger',
        ad: 'Triger Seti',
        km: '90.000 – 120.000 km',
        etiket: 'Kritik',
        aciklama: 'Porsche motorları için triger zinciri komple set. Boxster/Cayman/911 için farklı setler.',
        parcalar: [
          { ad: 'Triger Seti (Zincir + Gergi + Kasnak)', marka: 'INA / OEM' },
          { ad: 'V Kayışı (Aksesuar)', marka: 'Contitech / Gates' },
          { ad: 'Soğutma Sıvısı', marka: 'OEM / BASF' },
        ],
        tahminiSure: 'Stoktan 2-5 gün',
        garantiNotu: 'Orijinal Porsche şart (motor hasarı riski)',
      },
    ],
  },
]
