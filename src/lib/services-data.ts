...
export const services: Service[] = [
  ...
  },
  {
    slug: 'egzoz',
    title: 'Egzoz & Emisyon Sistemi',
    shortDescription: 'Katalizör, DPF/GPF, egzoz manifoldu, lambda ve EGR parçaları',
    longDescription:
      'VAG grubu araçlarınız için egzoz ve emisyon sistemi parçaları. Euro 6 normlarına uygun orijinal ve yan sanayi seçenekleri. Dizel araçlarda DPF/GPF, benzinli araçlarda katalizör kritik parçalardır.',
    iconName: 'Wind',
    color: '#64748B',
    gradient: 'from-slate-600 to-gray-700',
    features: ['Katalizör', 'DPF/GPF', 'Lambda Sensörü', 'EGR Valfi'],
    parts: [
      { name: 'Katalizör (Euro 6)', description: '1.4 TSI / 1.6 TDI / 2.0 TDI', brand: 'OEM, Walker' },
      { name: 'DPF (Dizel Partikül Filtresi)', description: '1.6/2.0 TDI Euro 6', brand: 'OEM, Bosal' },
      { name: 'GPF (Benzinli Partikül Filtresi)', description: '1.5 TSI / 2.0 TSI', brand: 'OEM, Walker' },
      { name: 'Egzoz Manifoldu', description: 'Turbo motorlar için', brand: 'OEM, Fa1' },
      { name: 'Lambda Sensörü (O2)', description: 'Ön + arka', brand: 'Bosch, NGK, Denso' },
      { name: 'EGR Valfi', description: 'Dizel motorlar', brand: 'Pierburg, Wahler' },
    ],
    faqs: [
      { question: 'DPF tıkanırsa ne yapmalı?', answer: 'Önce rejenerasyon denenmeli (yüksek devirli 30 dk sürüş). Başarısızsa DPF temizleme veya değişim gerekebilir.' },
      { question: 'Spor egzoz yasal mı?', answer: 'TÜV onaylı (E-mark) spor egzozlar yasal. Onaysız egzozlar cezaya tabi ve sigorta sorunu yaratır.' },
